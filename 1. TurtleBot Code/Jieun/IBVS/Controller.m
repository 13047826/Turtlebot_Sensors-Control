classdef Controller
    properties
        ...
        lambda = 0.4;                       % optimal lambda from tuning
        ...
        KpLinear = 0.2;                     % Linear PID gains from PID tuning
        KiLinear = 0.05;
        KdLinear = 0.0;
    
        KpAngular = 0.1;                    % Angular PID gains from PID tuning
        KiAngular = 0.015;
        KdAngular = 0.0;
        ...
        controlMode = 'IBVS';               % Two options: IBVS, PID
    ...
    methods
        ...
        function [minDistance, index, Z, isValid] = lidarDepth(obj, lidarMsg)
