classdef IBVSControllerKdTest
    properties
        ...
        KpLinear = 0.0;                     % Linear PID gains
        KiLinear = 0.0;
        KdLinear = 0.0;
    
        KpAngular = 0.12;                    % Angular PID gains
        KiAngular = 0.01;
        KdAngular = 0.015;
    ...
    methods
        ...
        function obj = IBVSControllerKdTest()
        ...
        function [vLinear, vAngular, edZ, edX] = PIDControl(obj, m, Z)
